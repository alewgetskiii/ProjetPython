...
annual_variables = [col for col in dataAnalyser._returns.columns[1:] if dataAnalyser.getFrequencyReturns(col)==365]
monthly_variables = [col for col in dataAnalyser._returns.columns[1:] if dataAnalyser.getFrequencyReturns(col)==31]
weekly_variables = [col for col in dataAnalyser._returns.columns[1:] if dataAnalyser.getFrequencyReturns(col)==7]
daily_variables = [col for col in dataAnalyser._returns.columns[1:] if dataAnalyser.getFrequencyReturns(col)==1]
